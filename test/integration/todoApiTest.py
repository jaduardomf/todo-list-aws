...
BASE_URL = "https://aqrolo1u9b.execute-api.us-east-1.amazonaws.com/Prod"
print(BASE_URL)
...
class TestApi(unittest.TestCase):
    ...
    def test_api_gettranslatedtodo(self):
        print('---------------------------------------')
        print('Starting - integration test Get Translated TODO')
        #Add TODO
        url = BASE_URL+"/todos"
        data = {
        ...
        self.assertEqual(
            jsonbody['text'], "Integration text example - GET TRANSLATED", "Error en la petición API a {url}"
        )
        #Test GET TODO
        ...
        self.assertEqual(
            json_response['text'], "Texto de integración de ejemplo - OBTENER TRADUCIDO", "Error en la petición API a {url}"
        )
        #Delete TODO to restore state
        response = requests.delete(url)
        self.assertEqual(
